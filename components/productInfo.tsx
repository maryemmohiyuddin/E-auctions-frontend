...
import {CloseButton, toast, ToastContainer} from 'react-toastify' // Import toast for notifications
		...
		<>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-7 mb-10">
					...
					<div className="col-span-1 flex flex-col gap-2">
						...
						<div className="flex gap-4 items-end justify-end mb-10 mt-3">
							<Button startContent={<MdDeleteOutline />} variant="bordered" color="danger" onClick={onDeleteModalOpen}>
								Delete Product
							</Button>
			...
			<Modal
				...
				classNames={{
					// header: 'pt-6',
					body: '',
					base: 'h-screen overflow-auto rounded-md fixed',
				...
				<ModalContent>
					...
					<ModalBody>
						...
						<Input type="text" label="Material" placeholder="Enter product material" labelPlacement="outside" value={material} onChange={(e) => setMaterial(e.target.value)} isInvalid={!!errors.material} errorMessage={errors.material} />
						...
						<Input type="number" label="Width (in inches)" placeholder="Enter product width" labelPlacement="outside" value={width} onChange={(e) => setWidth(e.target.value)} isInvalid={!!errors.width} errorMessage={errors.width} />

						<Input type="number" label="Height (in inches)" placeholder="Enter product height" labelPlacement="outside" value={height} onChange={(e) => setHeight(e.target.value)} isInvalid={!!errors.height} errorMessage={errors.height} />

						<Input type="number" label="Weight (in kg)" placeholder="Enter product weight" labelPlacement="outside" value={weight} onChange={(e) => setWeight(e.target.value)} isInvalid={!!errors.weight} errorMessage={errors.weight} />
					...
					<ModalFooter>
						...
						<Button color="secondary" onPress={handleEditProduct}>
							Save Changes
						</Button>
					</ModalFooter>
				</ModalContent>
