...
setProducts(filteredProducts)
  ...
  {categories.length > 0 ? (
    <Select
      ...
      onChange={(value) => handleProductCategoryChange(value)}
      className="mt-2"
    >
...
<ModalFooter>
  ...
  >
    Submit
      ...
      <Modal isOpen={isManageCategoriesOpen} onOpenChange={onManageCategoriesOpenChange}>
        <ModalContent>
...
<p>Welcome to Your Products Page! Here, you can easily manage your products by adding new items, editing existing ones, or removing those you no longer need. Whether you're updating details, adjusting prices, or showcasing new inventory, this page provides all the tools you need to keep your product listings up to date and organized. Enjoy a seamless experience as you manage your products with ease!</p>
        </div>
   <div className="flex  gap-3 my-5">
      ...
      <div className="flex flex-wrap">
        ...
        }}  variant={'solid'} aria-label="Tabs variants" isVertical>
...
<div className='w-full'>
      ...
      <div className="gap-3 grid grid-cols-3 sm:grid-cols-4 w-full">

        {products.map((item:any, index:any) => (
          <Card shadow="sm" key={index} isPressable           onPress={() => handleProductClick(item.id)}  // Use the handler to navigate
